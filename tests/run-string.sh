...
./compiler/shu -L . tests/string/contains_trim_replace.su -o /tmp/shu_string_ctr 2>&1
...
./compiler/shu -L . tests/string/view_zerocopy.su -o /tmp/shu_string_view 2>&1
