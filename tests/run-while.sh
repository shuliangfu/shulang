...
./compiler/shu tests/while/never.su -o /tmp/shu_while_never 2>&1
exitcode=0
...
./compiler/shu tests/while/break_out.su -o /tmp/shu_while_break 2>&1
exitcode=0
...
./compiler/shu tests/while/continue_never.su -o /tmp/shu_while_cont 2>&1
exitcode=0
...
./compiler/shu tests/while/loop_break.su -o /tmp/shu_loop_break 2>&1
exitcode=0
...
if ./compiler/shu tests/while/break_outside.su -o /tmp/shu_break_out 2>&1 | grep -q "only allowed inside a loop"; then
