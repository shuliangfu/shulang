...
# 测试 1+2 -> 退出码 3
./compiler/shu tests/binary-expr/main.su -o /tmp/shu_binary_expr 2>&1
exitcode=0
...
# 测试 42-10 -> 退出码 32
./compiler/shu tests/binary-expr/sub.su -o /tmp/shu_binary_sub 2>&1
exitcode=0
...
# 测试 6*7 -> 退出码 42
./compiler/shu tests/binary-expr/mul.su -o /tmp/shu_binary_mul 2>&1
exitcode=0
...
# 测试 20/4 -> 退出码 5
./compiler/shu tests/binary-expr/div.su -o /tmp/shu_binary_div 2>&1
exitcode=0
...
./compiler/shu tests/binary-expr/precedence.su -o /tmp/shu_binary_prec 2>&1
exitcode=0
...
# 测试括号：(1+2)*3 = 9
./compiler/shu tests/binary-expr/paren.su -o /tmp/shu_binary_paren 2>&1
exitcode=0
...
# 测试一元负号：10 + -4 = 6
./compiler/shu tests/binary-expr/unary_neg.su -o /tmp/shu_binary_neg 2>&1
exitcode=0
