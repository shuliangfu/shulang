...
uint8_t * labi_od_heap_api_sym_at(int32_t i) {
  ...
  if ((i ==25)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x74\x72\x61\x63\x65\x5f\x6f\x6e");
    return p;
  }
  if ((i ==26)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x74\x72\x61\x63\x65\x5f\x72\x65\x73\x65\x74");
    return p;
  }
  if ((i ==27)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x61\x72\x65\x6e\x61\x36\x34\x5f\x65\x6d\x70\x74\x79");
    return p;
  }
  if ((i ==28)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x61\x72\x65\x6e\x61\x36\x34\x5f\x69\x6e\x69\x74");
    return p;
  }
  if ((i ==29)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x61\x72\x65\x6e\x61\x36\x34\x5f\x64\x65\x69\x6e\x69\x74");
    return p;
  }
  if ((i ==30)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x6d\x65\x6d\x5f\x73\x65\x74");
    return p;
  }
  if ((i ==31)) {
    uint8_t * p = ((uint8_t *)"\x73\x74\x64\x5f\x68\x65\x61\x70\x5f\x6d\x65\x6d\x5f\x63\x6f\x6d\x70\x61\x72\x65");
    return p;
  }
  return ((uint8_t *)(0));
}
...
uint8_t * labi_od_zlib_undef_sym_at(int32_t i) {
  ...
  if ((i ==16)) {
    uint8_t * p = ((uint8_t *)"_std_compress_gzip_compress");
    return p;
  }
  if ((i ==17)) {
    uint8_t * p = ((uint8_t *)"_std_compress_gzip_decompress");
    return p;
  }
  if ((i ==18)) {
    uint8_t * p = ((uint8_t *)"std_compress_gzip_compress");
    return p;
  }
  if ((i ==19)) {
    uint8_t * p = ((uint8_t *)"std_compress_gzip_decompress");
    return p;
  }
  if ((i ==20)) {
    uint8_t * p = ((uint8_t *)"_std_compress_compress_init");
    return p;
  }
  if ((i ==21)) {
    uint8_t * p = ((uint8_t *)"std_compress_compress_init");
    return p;
  }
  return ((uint8_t *)(0));
}
