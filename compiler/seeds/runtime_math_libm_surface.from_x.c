...
/* fdlibm e_asin.c / e_acos.c / s_atan.c surface twins — isomorphic with
 * math_asin_c / math_acos_c / math_atan_c in src/asm/runtime_math_libm.x.
 * Shared R(t)=p/q in twin_asin_rational (G.7). Full-precision literals
 * (do not paste lossy -E %f). PLATFORM: SHARED — FP contraction OFF. */
#pragma STDC FP_CONTRACT OFF
