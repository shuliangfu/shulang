 ...
 *   + 9 full implementations (9.2.4: math_exp_c / math_log_c / math_sqrt_c /
 *   math_cbrt_c / math_expm1_c / math_log1p_c / math_sin_c / math_cos_c /
 *   math_tan_c fdlibm ports, isomorphic with
 *   the .x authority; matching math_*_impl bridges for those nine are gone).
 * Cap residual: remaining extern bridges (math_*_impl) for pow/asin/acos/atan/atan2/erf/...
 ...
 *   + thin+rest forwards to math_*_impl + 9 full impls
 *   (exp/log/sqrt/cbrt/expm1/log1p/sin/cos/tan).
