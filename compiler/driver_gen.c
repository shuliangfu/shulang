...
extern ptrdiff_t std_fs_fs_write(int32_t, uint8_t *, size_t);
...
int32_t main_driver_argv_parse_su_path(int32_t argc, uint8_t * argv, struct main_DriverSuEmitState * state) {
  ...
  continue;
    ...
    (void)(({ int32_t __tmp = 0; if (len == 2 && (arg_buf)[0] == 45 && (1 < 0 || (1) >= 512 ? (shulang_panic_(1, 0), (arg_buf)[0]) : (arg_buf)[1]) == 111) {   (void)((has_o = 1));
  (void)((i = i + 1));
...
int32_t main_driver_argv_parse_su(int32_t argc, uint8_t * argv, struct main_DriverSuEmitState * state) {
  ...
  (void)(({ int32_t __tmp = 0; if (main_eq_minus_E(arg_buf, elen) != 0) {   int32_t plen = driver_get_argv_i(argc, argv, i + 2, (state)->path_buf, 512);
...
int32_t main_driver_run_su_emit_su(struct main_DriverSuEmitState * state) {
  ...
  int32_t k = 0;
  int32_t fd = std_fs_fs_open_read(path_buf);
  ...
  uint8_t arena_buf[2097152] = { 0 };
  uint8_t module_buf[524288] = { 0 };
  struct ast_PipelineDepCtx ctx = ({ struct ast_PipelineDepCtx _t = { 0 }; _t.ndep = 0; _t.entry_dir_len = 0; _t.num_lib_roots = 0; _t.loaded_len = 0; _t.preprocess_len = 0; _t.use_asm_backend = (state)->use_asm_backend; _t.target_arch = (state)->target_arch; _t.use_macho_o = 0; _t.use_coff_o = 0; _t.current_block_ref = 0; _t; });
  ...
  struct main_PipelineSourceSlice source_slice = (struct main_PipelineSourceSlice){ .data = preprocess_buf, .length = source_len };
  int32_t rc = pipeline_run_su_pipeline_impl(arena_buf, module_buf, (&(source_slice)), (&(out)), (&(ctx)));
  size_t len = (out).len;
  while (k < (state)->path_len && k < 512) {
    (void)(((k < 0 || (k) >= 512 ? (shulang_panic_(1, 0), 0) : ((path_buf)[k] = (k < 0 || (k) >= 512 ? (shulang_panic_(1, 0), ((state)->path_buf)[0]) : ((state)->path_buf)[k]), 0))));
    (void)((k = k + 1));
  }
  while (k < (state)->path_len && k < 512) {
  ...
  (void)(({ int32_t __tmp = 0; if (k < 512) {   (void)(((k < 0 || (k) >= 512 ? (shulang_panic_(1, 0), 0) : ((path_buf)[k] = 0, 0))));
 } else (__tmp = 0) ; __tmp; }));
  ...
  (void)((k = 0));
  (void)(({ int32_t __tmp = 0; if (rc != 0) {   return 1;
 } else (__tmp = 0) ; __tmp; }));
  (void)(({ int32_t __tmp = 0; if (len > 262144) {   ptrdiff_t written = std_fs_fs_write(1, (out).data, 262144);
