...
cc_inc_tu_seed_for_out() {
  ...
  case "$(basename "$1")" in
  build_tool_main.o|crt0_mingw.o|pipeline_glue_link.o|pipeline_wpo_typecheck_emit_bridge.o|typeck_lsp_io_stub.o|pipeline_wpo_strict_link_alias.o|driver_compile_asm_link_alias.o|pipeline_asm_run_all_alias.o)
    local _btm_prod=""
